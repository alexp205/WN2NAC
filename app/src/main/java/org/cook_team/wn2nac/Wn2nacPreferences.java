...
public class Wn2nacPreferences {
    ...
    public static void read() {
        SharedPreferences sharedPref = Wn2nacService.context.getSharedPreferences(Wn2nacService.context.getString(R.string.preference_file_key), Context.MODE_PRIVATE);
        ...
        Wn2nacHistory.nextSeq = sharedPref.getInt("nextSeq", 1);
    }
