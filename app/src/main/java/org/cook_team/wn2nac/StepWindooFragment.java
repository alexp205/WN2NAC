...
public class StepWindooFragment extends android.support.v4.app.Fragment implements Switch.OnCheckedChangeListener, SensorEventListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_step_windoo, container, false);
